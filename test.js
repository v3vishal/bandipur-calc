        ...
        // Display population threshold as labels
        for (let level = 1; level < populationData.length; level++) {
            const plantsNeeded = populationData[level];
            const chartInstance = energyChart; // Replace with your actual Chart instance
            const dataset = chartInstance.data.datasets[0]; // Assuming you have one dataset

            // Access the y-axis scale
